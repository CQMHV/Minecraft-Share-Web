...
import { onRequestGet as __indexnow_js_onRequestGet } from "D:\\29224\\Documents\\My Projects\\Web\\Minecraft Share\\functions\\indexnow.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__indexnow_js_onRequestGet],
    },
  {
      routePath: "/indexnow",
      mountPath: "/",
